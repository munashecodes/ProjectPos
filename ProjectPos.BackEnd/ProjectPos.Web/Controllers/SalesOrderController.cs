    ...
    public class SalesOrderController : Controller
{
    ...
    public ActionResult GetSalesOrderItems([FromQuery] int? id)
    {
        return Ok(_service.GetSalesOrderItems(id));
    }

    [HttpGet("api/getAllMonthSalesOrderItems/{month:int}")]
    public ActionResult GetMonthSalesOrderItems(int month, [FromQuery] int? id)
    {
        return Ok(_service.GetMonthSalesOrderItems(month, id));
    }
    ...
    [HttpGet("api/getAllSalesOrderItemByRange")]
    public ActionResult GetSalesOrderItemsByRange([FromQuery] int? id, [FromQuery] DateTime start, [FromQuery] DateTime end)
    {
        return Ok(_service.GetSalesOrderItemsByRange(start, end, id));
    }
